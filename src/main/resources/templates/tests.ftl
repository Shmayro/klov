            ...
            <div class="padding">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="categories" onchange="location = this.value;">
                                        <#if RequestParameters.name??>
                                            ...
                                            <#list categoryList as category>
                                                <#if RequestParameters.category?? && RequestParameters.category == category>
                                                    <option value="/tests?name=${RequestParameters.name}&category=${category}"
                                        ...
                                        <#else>
                                            ...
                                            <#list categoryList as category>
                                                <#if RequestParameters.category?? && RequestParameters.category == category>
                                                    <option value="/tests?category=${category}"
                                                            selected>${category}</option>
                                                <#else>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="features" onchange="location = this.value;">
                                        <#if RequestParameters.category??>
                                            <option value="/tests?category=${RequestParameters.category}">All Features
                                            </option>
                                            <#list nameList as name>
                                                <#if RequestParameters.name?? && RequestParameters.name == name>
                                                    <option value="/tests?category=${RequestParameters.category}&name=${name}"
                                    ...
                                    <div class="box">
                                        <div class="box-header">
                                            ...
                                            <div>
                                                ...
                                                <#else>
                                                    <span class="label blue-grey"><i
                                                                class="fa fa-tag"></i> &nbsp; ${report.name}</span>
                                                    <span class="label blue-grey"><i
                                                                class="fa fa-tag"></i> &nbsp; ${report.name}</span>
                                                </#if>
                                            </div>
                                        ...
                                        <div class="box-tool">
                                            <ul class="nav">
                                                <li class="nav-item inline">
                                                    <a class="nav-link" alt="View all tests" title="View all tests"
                                                       href="/test?id=${test.id}">
                                                        <button class="btn btn-icon white"><i class="material-icons">input</i>
                                                        </button>
                                                    </a>
                                                </li>
                                                <li class="nav-item inline">
                                                    <a class="nav-link" alt="View failed tests"
                                                       title="View failed tests" href="/test?id=${test.id}&status=fail">
                                                        <button class="btn btn-icon white"><i class="material-icons">report</i>
                                                        </button>
                                                    </a>
                                                </li>
                                                <!-- if admin -->
                                                <#if user?? && user.admin>
                                                    <li class="nav-item inline">
                                                        <a class="nav-link"
                                                           ng-click="remove('${test.id}', 'r${test?counter}')" href="#"
                                                           alt="Delete test" title="Delete test">
                                                            <button class="btn btn-icon white"><i
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div>
                                                <div class="peity-chart" data-provide="peity" data-type="bar"
                                                     data-height="70" data-width="90"
                                                     data-fill="#33cabb,#48b0f7,#fdd501">${featurePassed}
                                                    ,${featureFailed},${featureOthers}</div>
                                                <ul class="pull-right list-inline align-self-end text-muted text-right mb-0">
                                                    <#if featurePassed gt 0>
                                                        <li>${featurePassed}% Pass &nbsp; <span
                                                            class="badge badge-ring badge-primary ml-2"></span>
                                                        </li></#if>
                                                    <#if featureFailed gt 0>
                                                        <li>${featureFailed}% Failed &nbsp; <span
                                                            class="badge badge-ring badge-danger ml-2"></span>
                                                        </li></#if>
                                                    <#if featureOthers gt 0>
                                                        <li>${featureOthers}% Others &nbsp; <span
                                                            class="badge badge-ring badge-yellow ml-2"></span>
                                                        </li></#if>
                                                </ul>
                                                <#if (report.parentLength)?? && report.parentLength gt 0>
                                                    <ul class="pull-left list-inline align-self-start text-right mb-0">
                                                        <#if report.parentLength gt 0>
                                                            <li><span
                                                                    class="label green-graph">${report.passParentLength}/${report.parentLength} pass</span>
                                                            </li></#if>
                                                        <#if (report.failParentLength+report.fatalParentLength+report.errorParentLength) gt 0>
                                                            <li><span
                                                                    class="label red-graph">${report.failParentLength+report.fatalParentLength+report.errorParentLength}/${report.parentLength} failed</span>
                                                            </li></#if>
                                                        <#if (report.skipParentLength+report.warningParentLength) gt 0>
                                                            <li><span
                                                                    class="label yellow-graph">${report.skipParentLength+report.warningParentLength}/${report.parentLength} others</span>
                                                            </li></#if>
                                                    </ul>
                                                <#else>
                                                    <ul class="pull-left list-inline align-self-start text-right mb-0">
                ...
                <ul class="pagination">
                    ...
                    <#list page-3..page+2 as x>
                        <#if x gte 0 && (x lte pages-1) >
                            <li class="page-item"><a class="page-link" href="${url}&page=${x}">${x+1}</a></li></#if>
                    </#list>
                    <#assign disabled="">
