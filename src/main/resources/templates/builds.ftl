                                    ...
                                    <div class="box">
                                            ...
                                            <ul class="nav">
                                                ...
                                                <li class="nav-item inline">
                                                    <a class="nav-link" alt="View failed tests"
                                                       ...
                                                       href="/build?id=${report.id}&status=fail">
                                                ...
                                                <#if user?? && user.admin>
                                                    <li class="nav-item inline">
                                                        <a class="nav-link"
                                                           ng-click="remove('${report.id}', 'r${report?counter}')"
                                                           href="#" alt="Delete report" title="Delete report">
                                        ...
                                        <div class="box-body">
                                            <p class="m-a-0">
                                                ...
                                                ${report.passParentLength} passed. This build has a success percentage
                                                of ${featurePassed}%.
                                            </p>
                                            <#if report.parentLength != 0>
                                                <div class="mt-70">
                                                    <div class="peity-chart" data-provide="peity" data-type="bar"
                                                         data-height="130" data-width="90"
