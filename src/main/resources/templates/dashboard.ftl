                ...
                <div class="col-lg b-r">
                        ...
                        <div class="col-xs-6 col-sm-3 b-r b-b">
                            <div class="padding">
                                ...
                                <div class="text-center">
                                    ...
                                    <div>
                                        <span data-ui-jp="sparkline"
                                              data-ui-options="[2,3,2,2,1,3,6,3,2,1], {type:'line', height:20, width: '60', lineWidth:1, valueSpots:{'0:':'#818a91'}, lineColor:'#818a91', spotColor:'#818a91', fillColor:'', highlightLineColor:'rgba(120,130,140,0.3)', spotRadius:0}"
                        ...
                        <div class="col-xs-6 col-sm-3 b-r b-b">
                            <div class="padding">
                                ...
                                <div class="text-center">
                                    ...
                                    <div>
                                        <span data-ui-jp="sparkline"
                                              data-ui-options="[1,1,0,2,3,4,2,1,2,2], {type:'line', height:20, width: '60', lineWidth:1, valueSpots:{'0:':'#818a91'}, lineColor:'#818a91', spotColor:'#818a91', fillColor:'', highlightLineColor:'rgba(120,130,140,0.3)', spotRadius:0}"
                                              class="sparkline inline"></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6 col-sm-3 b-r b-b">
                            <div class="padding">
                                ...
                                <div class="text-center">
                                    ...
                                    <div>
                                        <span data-ui-jp="sparkline"
                                              data-ui-options="[9,2,5,5,7,4,4,3,2,2], {type:'line', height:20, width: '60', lineWidth:1, valueSpots:{'0:':'#818a91'}, lineColor:'#818a91', spotColor:'#818a91', fillColor:'', highlightLineColor:'rgba(120,130,140,0.3)', spotRadius:0}"
                                              class="sparkline inline"></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-6 col-sm-3 b-b">
                            <div class="padding">
                                ...
                                <div class="text-center">
                                    ...
                                    <div>
                                        <span data-ui-jp="sparkline"
                                              data-ui-options="[3,3,1,62,4,3,7,3,2,5], {type:'line', height:20, width: '60', lineWidth:1, valueSpots:{'0:':'#818a91'}, lineColor:'#818a91', spotColor:'#818a91', fillColor:'', highlightLineColor:'rgba(120,130,140,0.3)', spotRadius:0}"
                                              class="sparkline inline"></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="padding">
                        ...
                        <div class="box">
                            ...
                            <div class="box-tool">
                                <div class="dropdown">
                                    <a data-toggle="dropdown" class="btn btn-xs rounded white dropdown-toggle">Select
                                        Period</a>
                                    <div class="dropdown-menu pull-right">
                                        <a class="dropdown-item" href="#" ng-click="getPeriodReportAggregation(1)">Last
                                            24 hours</a>
                                        <a class="dropdown-item" href="#" ng-click="getPeriodReportAggregation(7)">Last
                                            7 days</a>
                                        <a class="dropdown-item" href="#" ng-click="getPeriodReportAggregation(14)">Last
                                            14 days</a>
                                        <a class="dropdown-item" href="#" ng-click="getPeriodReportAggregation(21)">Last
                                            21 days</a>
                                        <a class="dropdown-item" href="#" ng-click="getPeriodReportAggregation(30)">Last
                                            30 days</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item">Today</a>
                                    </div>
                                            ...
                                            <#list categoryList as category>
                                                ...
                                                <li class="list-item">
                                                    ...
                                                    <div class="list-body">
                                                        ...
                                                        <small class="text-muted text-ellipsis">${category.total}
                                                            tests</small>
                                                    </div>
                                                </li>
                                                <#assign cntr++>
                                                ...
                                                <#list authorList as author>
                                                    ...
                                                    <li class="list-item">
                                                        ...
                                                        <div class="list-body">
                                                            ...
                                                            <small class="text-muted text-ellipsis">${author.total}
                                                                tests</small>
                                                        </div>
                                                    </li>
                                                    <#assign cntr++>
