                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body kl">
                                <#if report.parentLength != 0>
                                    <div class="">
                                        <div class="peity-chart" data-provide="peity" data-type="bar" data-height="130"
                                             data-width="90" data-fill="#33cabb,#48b0f7,#fdd501">${featurePassed}
                                        ...
                                        <ul class="pull-right list-inline align-self-end text-muted text-right mb-0">
                                            <li>${featurePassed}% Pass &nbsp; <span
                                                        class="badge badge-ring badge-primary ml-2"></span></li>
                                            <li>${featureFailed}% Failed &nbsp; <span
                                                        class="badge badge-ring badge-danger ml-2"></span></li>
                                            <li>${featureOthers}% Others &nbsp; <span
                                                        class="badge badge-ring badge-yellow ml-2"></span></li>
                                        </ul>
                                    </div>
                                </#if>
                            </div>
                    ...
                    <#if isBDD>
                        <div class="col-sm-4">
                            <div class="box">
                                ...
                                <div class="box-body kl">
                                    <div class="peity-chart" data-provide="peity" data-type="bar" data-height="130"
                                         data-width="90" data-fill="#33cabb,#48b0f7,#fdd501">${report.passChildLength}
                                        ,${report.failChildLength},${report.skipChildLength}</div>
                                    <ul class="pull-right list-inline align-self-end text-muted text-right mb-0">
                                        <li>${100*report.passChildLength/report.childLength}% Pass &nbsp; <span
                                                    class="badge badge-ring badge-primary ml-2"></span></li>
                                        <li>${100*report.failChildLength/report.childLength}% Failed &nbsp; <span
                                                    class="badge badge-ring badge-danger ml-2"></span></li>
                                        <li>${100*report.skipChildLength/report.childLength}% Others &nbsp; <span
                                                    class="badge badge-ring badge-yellow ml-2"></span></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="box">
                                ...
                                <div class="box-body kl">
                                    <div class="peity-chart" data-provide="peity" data-type="bar" data-height="130"
                                         data-width="90"
                                         data-fill="#33cabb,#48b0f7,#fdd501">${report.passGrandChildLength}
                                        ,${report.failGrandChildLength},${report.skipGrandChildLength}</div>
                                    <ul class="pull-right list-inline align-self-end text-muted text-right mb-0">
                                        <li>${100*report.passGrandChildLength/report.childLength}% Pass &nbsp; <span
                                                    class="badge badge-ring badge-primary ml-2"></span></li>
                                        <li>${100*report.failGrandChildLength/report.childLength}% Failed &nbsp; <span
                                                    class="badge badge-ring badge-danger ml-2"></span></li>
                                        <li>${100*report.skipGrandChildLength/report.childLength}% Others &nbsp; <span
                                                    class="badge badge-ring badge-yellow ml-2"></span></li>
                                    </ul>
                                </div>
                            </div>
