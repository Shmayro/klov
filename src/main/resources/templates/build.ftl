                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu text-color pull-right" role="menu">
                                                <#list statusList as status>
                                                    <a href="/build?id=${report.id}&status=${status?lower_case}"
                                                       class="dropdown-item">
                                                ...
                                                <div class="list-item">
                                                    <div class="list-body">
                                                        ...
                                                        <div class="item-title"
                                                             ng-click="findTest('${test.id}', false)">
                                        ...
                                        <#if isBDD>
                                            <div class="p-a" ng-if="currentTest">
                                                ...
                                                <div ng-if="currentTest.categoryNameList">
															<span class="label rounded warn" style="margin-right:2px;"
                                                                  ng-repeat="category in currentTest.categoryNameList">
																<i class="fa fa-tag"></i> &nbsp;
																{{category}}
															</span>
                                                </div>
                                                ...
                                                <div class="" ng-if="currentTest.nodes.length">
                                                    ...
                                                    <div class="p-a box border-box light"
                                                        ...
                                                        <div style="margin-top:-10px;margin-bottom:10px;"
                                                             ng-if="node1.categoryNameList">
																	<span class="label rounded warn"
                                                                          ng-repeat="category in node1.categoryNameList">
																		<i class="fa fa-tag"></i> &nbsp;
																		{{category}}
																	</span>
                                                        </div>
                                                        ...
                                                        <div class="p-a" ng-if="node1.nodes.length">
                                                            ...
                                                            <div ng-repeat="node2 in node1.nodes">
                                                                ...
                                                                <div ng-if="node2.categoryNameList">
																			<span class="label rounded warn"
                                                                                  ng-repeat="category in node2.categoryNameList">
																				<i class="fa fa-tag"></i> &nbsp;
																				{{category}}
																			</span>
                                                                </div>
                                        ...
                                        <div class="p-a" ng-if="historicalTest">
                                            ...
                                            <div class="bdd-node" ng-if="historicalTest.nodes.length">
                                                ...
                                                <div class="p-a box border-box"
                                                    ...
                                                    <h6><small class="_600"
                                                               ng-if="nodeH1.bddType">{{nodeH1.bddType}}:</small>
                                                        {{nodeH1.name}}</h6>
                                                    ...
                                                    <div ng-if="nodeH1.nodes.length">
                                                        <!-- nodes -->
                                                        <div ng-repeat="nodeH2 in nodeH1.nodes" ng-class="nodeH2.status"
                                                             class="node p-a">
                                    ...
                                    <div class="p-a" ng-if="historicalList">
                                        ...
                                        <table class="table table-striped b-t">
                                            ...
                                            <tr ng-repeat="history in historicalList">
                                                <td><a href="#"
                                                       ng-click="findTest(history.id, true)">{{history.name}}</a></td>
                                                <td>{{history.startTime | date: 'MMM dd, yyyy hh:mm:ss'}}</td>
                                                <td>
                                                    <span class="label {{getColor(history.status)}}">{{history.status}}</span>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
